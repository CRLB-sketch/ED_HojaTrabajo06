...
public class View {
    ...
    public String mainMenu(IMap map){
        ...
        System.out.println("2. Agregar un producto a la colecci�n del usuario.");  //Producto agregado a la lista de compras
        System.out.println("3. Mostrar la categor�a de un producto."); // La categoria del producto es "Lacteos" // Ya esta
        System.out.println("4. Mostrar carrito de compra (Ordenado por categor�a)."); //Un for, pero ordenado por categoria
    ...
    public void errorMap(){
        System.out.println("--> HEY! Todav�a no has definido un map, tienes que definir uno");
    }
    ...
    /** 
     * Método para mostrar información adicional e importante
     * 
